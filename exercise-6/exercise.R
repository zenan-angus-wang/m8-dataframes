...
setwd('/Users/zenanwang/Desktop/info201/in-class-practice/m8-dataframes/exercise-6/data')
...
MostPopular <- function(my.year) {
  popularName <- name[max(prop[year == my.year])]
  return popularName
}
